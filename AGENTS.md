...
- `PANDATASK_TOOL_PROFILE=core` is the normal interactive profile. First-class work/time tools (`task_complete`, `task_time_resolve`, `work_log`, `work_list`, `work_report`) are part of `core` and must remain covered by profile tests.
