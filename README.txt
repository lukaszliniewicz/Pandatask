...
* Convert Markdown pasted directly into task descriptions, preserve editable Mermaid diagrams, and align UI/MCP description validation.

= 1.0.38 =

* Keep compact child tasks and relation controls visually muted inside the full-screen Flow portal.

= 1.0.37 =

* Content-hash lazy-loaded stylesheets so browsers and CDNs cannot combine new project views with stale component CSS.

= 1.0.36 =

* Isolate full-screen Flow in a dedicated fixed portal shell so host layout and theme rules cannot displace or restyle the canvas.

= 1.0.35 =

* Preserve Pandatask's scoped control and list styling when the Flow canvas is portaled above a host theme in full-screen mode.
