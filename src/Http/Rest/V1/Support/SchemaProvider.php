...
final class SchemaProvider {
    ...
    public function get_task_schema( $is_update = false ) {
        $schema = array(
            ...
            'name'                => array( 'description' => __( 'The name of the task.', 'pandatask' ), 'type' => 'string', 'required' => ! $is_update, 'maxLength' => 255, 'sanitize_callback' => 'sanitize_text_field' ),
            'estimated_effort_seconds' => array( 'description' => __( 'Expected effort in seconds.', 'pandatask' ), 'type' => 'integer', 'minimum' => 0 ),
            ...
            'board_name'          => array( 'description' => __( 'Destination board for a task move.', 'pandatask' ), 'type' => 'string', 'maxLength' => 191, 'sanitize_callback' => 'sanitize_key' ),
